...
class XXX: 
    def __init__(self, anzahl_paare: int, anzahl_spalten: int):
        # Input Validierung
        assert isinstance(anzahl_paare, int) and anzahl_paare > 0 and anzahl_paare <= 50, "Ungültige Eingabe für Anzahl Paare."
        assert isinstance(anzahl_spalten, int) and anzahl_spalten > 0 and anzahl_spalten <= 10, "Ungültige Eingabe für Anzahl Spalten."
